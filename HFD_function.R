...
HFD_check <- function(X,feas_targ,pu_feas,prior_feas){
  
  # X is the highest feasible dose count. Same as the X in Thall and Sung
  # feas_targ is the minimum required feasibility probability
  # pu_feas is the upper probabiltiy cuttoff for feasibility
  # prior feas is the prior values for each dose being feasible - q0 in Thall
