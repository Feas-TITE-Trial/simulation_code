...
get_tox_estimate <- function(skeleton,ylong,doselong,weight,ntreat,target,formal_bayesian,model,intcpt,s2){
  ...
  #model_mtd2 <- which.min(abs(phat_est2-target))
  
  #return(list(bhat_est=bhat_est,phat_est=phat_est,phat_est2=phat_est2,model_mtd=model_mtd,model_mtd2=model_mtd2))
